...
import styles from './AddProductMoped.module.css'

function AddProductMoped({ children, ...props }) {
	let { id } = useParams()
	...
	const [formData, setFormData] = useState({
		...
		gender: '',
		color: '',
		groupId: 8, // ID группы, которую нужно получить динамически
		type: '',
		price: '',
		priceForSale: '',
		ageGroup: '',
...
export default AddProductMoped
