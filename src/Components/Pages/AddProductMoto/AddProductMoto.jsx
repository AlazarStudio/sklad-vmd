...
import styles from './AddProductMoto.module.css'

function AddProductMoto({ children, ...props }) {
	let { id } = useParams()
	...
	return (
		<>
			{/* <Scanner /> */}
			<form className={styles.form_product} onSubmit={handleSubmit}>
